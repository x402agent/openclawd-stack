...
description: "Add, remove, or modify allowed endpoints in the NemoClawd sandbox policy inside the openclawd-stack."
keywords: ["customize nemoclawd network policy", "sandbox egress policy configuration", "openclawd-stack policy"]
...
Add, remove, or modify the endpoints that the NemoClawd sandbox is allowed to reach.
