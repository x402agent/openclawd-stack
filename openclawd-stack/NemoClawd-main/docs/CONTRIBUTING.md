...
This guide covers how to write, edit, and review documentation for NemoClawd inside the openclawd-stack. If you change code that affects user-facing behavior, update the relevant docs in the same PR.
...
tags: ["openclawd", "openshell", "nemoclawd", "relevant", "tags"]
content:
...
| xAI | Xai, XAI, xai (except as provider id) |
| NemoClawd | nemoclawd (in prose), Nemoclawd, NemoClaw |
| OpenClawd | openclawd (in prose), Openclawd, OpenClaw |
| OpenShell | Open Shell, openShell, Openshell, openshell |
| openclawd-stack | openclawd stack, OpenClawd Stack |
| $CLAWD | clawd, CLAWD (outside ticker references) |
| mTLS | MTLS, mtls |
| YAML | yaml, Yaml |
