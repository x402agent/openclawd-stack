...
description: "Inspect sandbox health, trace NemoClawd agent behavior, and diagnose problems in the openclawd-stack."
keywords: ["monitor nemoclawd sandbox", "debug nemoclawd agent issues", "openclawd-stack monitoring"]
...
| Wallet shows zero balance | Fund the Privy wallet or run `nemoclaw wallet status` to verify the configured RPC and wallet address. |
